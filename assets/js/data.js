...
const VIDEOS_TIMELINE = [
  {
    ...
    videos: [
      { src: '咪咕视频', color: 't-gold', title: '山东魏桥 vs 山东鲁能 王楚钦出战', meta: '男团常规赛第1轮', url: 'https://www.miguvideo.com/mgs/website/prd/sportsHomePage.html?tab=pingpong' },
    ]
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-red', title: '孙颖莎女单决赛 4-3胜蒯曼', meta: '决胜局11-4锁定胜局 · 第6座大满贯', url: 'https://sports.cctv.cn/2026/07/06/VIDEQRtOqtjnGJ12g4xSvAZW260706.shtml' },
  ...
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-red', title: '女团决赛：中国3-2逆转日本夺冠', meta: '孙颖莎独得两分 · 最佳女运动员', url: 'https://tv.cctv.com/2026/05/11/VIDEeuVE6N2s94Oobq2utOZv260511.shtml' },
      { src: '央视体育', color: 't-blue', title: '男团决赛：中国3-0日本 12连冠', meta: '王楚钦10战全胜 · 最佳男运动员', url: 'https://ysxw.cctv.cn/article.html?item_id=14422630167200319599' },
    ]
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-gold', title: '王楚钦男单决赛 4-3胜松岛辉空', meta: '首夺世界杯男单冠军 · 2500分', url: 'https://sports.cctv.com/2026/04/05/VIDEbC6JbVoTymx81wkwjzNi260405.shtml' },
    ]
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-red', title: '孙颖莎女单决赛 4-2胜王曼昱', meta: '大满贯女单冠军 · 2000分', url: 'https://sports.cctv.com/2026/03/01/VIDE7aezdueWwNUCmExhvya3260301.shtml' },
      { src: '央视体育', color: 't-blue', title: '王楚钦男单决赛 4-0胜林昀儒', meta: '大满贯男单冠军 · 2000分', url: 'https://sports.cctv.com/2026/03/01/VIDE3NIm1cZcYbhXifjpqHwp260301.shtml' },
    ]
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-red', title: '孙颖莎女单决赛 4-3胜王曼昱', meta: '亚洲杯女单冠军 · 1000分', url: 'https://sports.cctv.com/2026/02/08/VIDEwWyfsrZsceKrCmstENUU260208.shtml' },
      { src: '央视体育', color: 't-blue', title: '王楚钦男单决赛 4-2胜张本智和', meta: '亚洲杯男单冠军(卫冕) · 1000分', url: 'https://sports.cctv.com/2026/02/08/VIDEwWyfsrZsceKrCmstENUU260208.shtml' },
    ]
  },
  {
    ...
    desc: '孙颖莎女单决赛2-4负王曼昱',
    videos: [
      { src: '央视体育', color: 't-gold', title: '孙颖莎女单决赛 2-4负王曼昱', meta: '大满贯女单亚军 · 2000分', url: 'https://sports.cctv.cn/2025/10/05/VIDE9J8JtLMe2qLo82AZZPPl251005.shtml' },
    ]
  },
  {
    ...
    desc: '孙颖莎女单4-2胜王曼昱夺冠',
    videos: [
      { src: '央视体育', color: 't-red', title: '孙颖莎女单决赛 4-2胜王曼昱', meta: '大满贯女单冠军 · 2000分', url: 'https://sports.cctv.com/2025/08/25/VIDEOASzVBnFZON9kFcAXtcY250825.shtml' },
    ]
  },
  {
    ...
    videos: [
      { src: '央视体育', color: 't-blue', title: '王楚钦男单夺冠 首夺世乒赛冠军', meta: '世乒赛男单冠军', url: 'https://content-static.cctvnews.cctv.com/snow-book/index.html?item_id=1373478323501308604' },
      { src: '央视体育', color: 't-red', title: '孙颖莎女单夺冠 蝉联冠军', meta: '世乒赛女单冠军(卫冕)', url: 'https://content-static.cctvnews.cctv.com/snow-book/index.html?item_id=9656292540558360789' },
    ]
  },
];
...
const TOURNAMENT_ARCHIVE = [
  {
    ...
    events: [
      ...
      { date: '2026-07-06', name: 'WTT美国大满贯', loc: '美国·洛杉矶', type: '大满贯', points: 2000,
        videoUrl: 'https://sports.cctv.cn/2026/07/06/VIDEQRtOqtjnGJ12g4xSvAZW260706.shtml',
        results: [
      ...
      { date: '2026-06-10', endDate: '2026-06-16', name: '伦敦世乒赛（团体）', loc: '英国·伦敦', type: '世乒赛',
        videoUrl: 'https://tv.cctv.com/2026/05/11/VIDEeuVE6N2s94Oobq2utOZv260511.shtml',
        results: [
      ...
      { date: '2026-04-15', endDate: '2026-04-21', name: 'WTT澳门世界杯', loc: '中国·澳门', type: '世界杯', points: 2500,
        videoUrl: 'https://sports.cctv.com/2026/04/05/VIDEbC6JbVoTymx81wkwjzNi260405.shtml',
        results: [
          { player: 'sun', event: '女单', result: '🥇 冠军', detail: '决赛4-1胜王曼昱（三连冠）' },
      ...
      { date: '2026-03-08', endDate: '2026-03-14', name: 'WTT新加坡大满贯', loc: '新加坡', type: '大满贯', points: 2000,
        videoUrl: 'https://sports.cctv.com/2026/03/01/VIDE7aezdueWwNUCmExhvya3260301.shtml',
        results: [
      ...
      { date: '2026-02-18', endDate: '2026-02-23', name: '亚洲杯', loc: '地点待确认', type: '洲际', points: 1000,
        videoUrl: 'https://sports.cctv.com/2026/02/08/VIDEwWyfsrZsceKrCmstENUU260208.shtml',
        results: [
  ...
  },
  {
    ...
    events: [
      ...
      { date: '2025-10', name: 'WTT中国大满贯', loc: '中国·北京', type: '大满贯', points: 2000,
        videoUrl: 'https://sports.cctv.cn/2025/10/05/VIDE9J8JtLMe2qLo82AZZPPl251005.shtml',
        results: [
          { player: 'sun', event: '女单', result: '🥈 亚军', detail: '决赛2-4负王曼昱' },
          { player: 'wang', event: '男单', result: '待补充', detail: '成绩以官方为准' },
        ], src: 'WTT官网', url: 'https://worldtabletennis.com/' },
      { date: '2025-08', name: 'WTT瑞典大满贯', loc: '瑞典·马尔默', type: '大满贯', points: 2000,
        videoUrl: 'https://sports.cctv.com/2025/08/25/VIDEOASzVBnFZON9kFcAXtcY250825.shtml',
        results: [
          { player: 'sun', event: '女单', result: '🥇 冠军', detail: '决赛4-2胜王曼昱' },
        ], src: 'WTT官网 / 央视体育', url: 'https://worldtabletennis.com/' },
      ...
      { date: '2025-05', name: '多哈世乒赛（单项）', loc: '卡塔尔·多哈', type: '世乒赛',
        videoUrl: 'https://content-static.cctvnews.cctv.com/snow-book/index.html?item_id=9656292540558360789',
        results: [
